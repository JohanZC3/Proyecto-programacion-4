...
public class UpdateUserFrame extends JFrame { 
    ...
    public void mostrarUpdateUserFrame(int ID,int userId) {
        ...
        addproviderButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (UsuarioServicio.validarInformacion(userName, userLastname, CC, providerAdress, phoneString, password, userType)) {
                    ...
                    UsuarioRepositorio.modificarUsuario(idint, usuario);
                    HistorialModal historialModal = new HistorialModal(idint, "Modificacion", "Usuario", userId);
    ...
    private void loadUserData(int Id) {
        Usuario usuario = UsuarioRepositorio.obtenerUsuarioPorId(Id);
        if (usuario != null) {
            idField.setText(String.valueOf(usuario.getId()));
            userNameField.setText(usuario.getNombre());
            userLastnameField.setText(usuario.getApellido());
            providerAdressField.setText(usuario.getDireccion());
            phoneField.setText(usuario.getTelefono());
            userTypeCB.setSelectedItem(usuario.getTipoUsuario());
            CCField.setText(usuario.getNumeroDocumento());
